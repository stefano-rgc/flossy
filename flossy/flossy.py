...
from PyQt5.QtWidgets import QApplication, QMainWindow, QTextBrowser, QVBoxLayout, QWidget, QFileDialog, QMessageBox, QDialog
...
<body>
    ...
    <div class="bullet1"><span class="underline">Spanner ON/OFF</span>: Enable/disable spanner mode (see Spanner mode section above).</div>
</body>
</html>
        '''
    ...
    def help(self, event):
        ...
        help_dialog.setGeometry(200, 100, 1300, 500)
        layout = QVBoxLayout(help_dialog)
        text_browser = QTextBrowser()
        text_browser.setOpenExternalLinks(True)
        layout.addWidget(text_browser)
        self.populate_help_content(text_browser)
        help_dialog.exec_()  # Show as modal dialog
